...
Stock Level Optimization: Suggests optimal reorder points and order quantities based on predicted demand and lead times.

Inventory Alerts: Identifies items that are overstocked or understocked and generates actionable alerts.

Cost Analysis: Calculates holding costs, shortage costs, and total inventory costs to help improve decision-making.
...
scikit-learn (optional): For machine learning-based forecasting.

statsmodels (optional): For statistical time series forecasting models.
